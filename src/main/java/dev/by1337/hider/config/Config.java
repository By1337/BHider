...
public class Config {
    ...
    public Config(ArmorHideSettings armorHide, List<Material> ignoreBlocks, HideSettings hideSettings) {
    ...
    public static class ArmorHideSettings {
        ...
        public ArmorHideSettings(double fieldOfView, Vec3d expandAabb, boolean hideMeta, Collection<String> disableWorlds, String bypassPermission) {
